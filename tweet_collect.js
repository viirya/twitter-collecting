...
(function() {
  var Buffer, EventEmitter, Geo, MongoDatabase, Stream, assert, cli, collecting, config, decodeLocation, http, options, prompt, properties, renew_twitter_client, twitterstream, _;
  ...
  renew_twitter_client = function(params) {
